...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    if ([self.gridDelegate respondsToSelector:@selector(infiniteGridView:didScrollToPage:)]) {
        CGPoint middlePointOffset = CGPointMake(scrollView.contentOffset.x + 150, scrollView.contentOffset.y); // 150 is 1/2 width of color bar
        UIView *grid = [self gridViewAtPoint:middlePointOffset];
