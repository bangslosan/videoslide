...
#import "SCPhotoStripItemView.h"
#import "UIView+GMGridViewAdditions.h"
#import "GMGridView.h"



@interface SCPhotoStripItemView () <UIGestureRecognizerDelegate>
...
@end
@implementation SCPhotoStripItemView
...
- (id)initWithFrame:(CGRect)frame slide:(SCSlideComposition*)slideComposition;
{
    ...
    if(self)
    {
        ...
        {
            self.photoImgView = [[UIImageView alloc]initWithFrame:CGRectMake(1, 1, self.bounds.size.width - 1, self.bounds.size.height - 2)];
